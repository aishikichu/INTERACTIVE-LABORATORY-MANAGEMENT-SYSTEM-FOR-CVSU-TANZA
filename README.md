Here is a GitHub repository description and a comprehensive `README.md` file tailored for your capstone project.

### **GitHub Repository Description**

> **Description:** A Python-based Interactive Laboratory Management System featuring RFID automated attendance, real-time activity tracking, and LAN-based instructor-student interaction. Developed for the computer laboratories of Cavite State University – Tanza Campus.
