...
👨‍🏫 Instructor Control Panel: * Launch applications (e.g., Python IDEs, Chrome, Eclipse) simultaneously on all connected student computers.

Set automated shutdown or sleep timers for student workstations.

📝 Activity & Quiz Management: * Instructors can upload, monitor, and toggle the availability of quizzes and coding activities.
...
Admin Module: Handles overall system management, user registry (Instructors/Students), and semester data resets.

Instructor Client: A dashboard for teachers to manage laboratory sessions, track attendance logs in real-time, initiate activities, and control student PC states.

Student Client: A localized application on laboratory workstations where students sign in via RFID, view instructions, take quizzes, and upload coding activities.
...
Lance Icy L. Antonio * J C Boy L. Ferrer
